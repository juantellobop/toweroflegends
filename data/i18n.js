...
const DICTIONARIES = {
  ...
  it: {
    ...
    leaderboard: { floor: ({ floor }) => `Piano ${floor}`, updating: 'Aggiornamento classifica...', readOnly: 'Server senza scrittura: mostro la classifica salvata.', rank: ({ rank }) => `La tua run è arrivata #${rank}.`, notTop: 'Non sei entrato nella top 20.', title: 'Classifica', top: 'Top 20', titleWeekly: 'Classifica settimanale', topWeekly: 'Top 20 settimanale', empty: 'Nessun punteggio ancora.', lineup: 'Ultimo undici' },
