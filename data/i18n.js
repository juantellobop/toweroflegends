...
const DICTIONARIES = {
  ...
  fr: {
    meta: { title: 'Torre de Leyendas', description: 'Roguelike de football : composez votre sélection avec des packs et grimpez une tour infinie.', footer: 'Torre de Leyendas · Projet non officiel / non affilié · Coupe des Légendes' },
  ...
  pt: {
    meta: { title: 'Torre de Leyendas', description: 'Roguelike de futebol: monte sua seleção abrindo pacotes e suba uma torre infinita.', footer: 'Torre de Leyendas · Projeto não oficial / não afiliado · Copa das Lendas' },
    language: { label: 'Idioma' },
  ...
  it: {
    meta: { title: 'Torre de Leyendas', description: 'Roguelike calcistico: costruisci la tua selezione aprendo pacchetti e scala una torre infinita.', footer: 'Torre de Leyendas · Progetto non ufficiale / non affiliato · Coppa delle Leggende' },
