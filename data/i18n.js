...
const DICTIONARIES = {
  es: {
    ...
    press: {
      ...
      body: {
        ...
        red: ({ player, team, minute }) => `El partido se complicó con la expulsión de ${player} a los ${minute} minutos, que dejó a ${team} en inferioridad y condicionó por completo el tramo final.`, forfeit: ({ team }) => `Con cuatro expulsados, ${team} se quedó sin equipo sobre el campo y el colegiado dio el partido por perdido.`,
  ...
  en: {
    ...
    press: {
      ...
      body: {
        ...
        red: ({ player, team, minute }) => `The match took a turn with ${player}'s sending-off in minute ${minute}, leaving ${team} a man down and completely conditioning the final stretch.`, forfeit: ({ team }) => `With four players sent off, ${team} could no longer field a side and the referee awarded the match as lost.`,
  ...
  fr: {
    ...
    result: { tier: { goleada: 'ROUSTE !', amplia: 'Large victoire', ajustada: 'Victoire serrée', empate: 'Match nul', derrota: 'Défaite' }, lostStep: 'Échelon perdu', towerFall: 'Chute de la tour', retry: 'Retenter l’échelon', nextLevel: 'Niveau suivant', reward: 'Récompense', lossCopy: ({ lives }) => `Vous avez perdu cet échelon. Il vous reste ${lives} vie${lives === 1 ? '' : 's'}.`, rewardCopy: ({ players, items }) => `Récompense prête : pack de ${players} joueurs et ${items} objets à choisir.`, scorers: 'Buteurs', reds: 'Expulsés', saves: 'Arrêts', lastMatch: 'Dernier match', lastTactic: 'Votre tactique', gameOver: 'Fin de run', floorsReached: 'étages atteints', newRecord: '★ Nouveau record', best: ({ best }) => `Meilleure marque : ${best}`, winsRoster: ({ wins, count }) => `${wins} victoire${wins === 1 ? '' : 's'} · effectif de ${count} joueurs`, route: 'Parcours', finalSquad: 'Effectif final', playAgain: 'Rejouer', pathLevel: ({ level }) => `Nv ${level}` },
    ...
    press: {
      ...
      body: {
        ...
        red: ({ player, team, minute }) => `Le match s’est compliqué avec l’expulsion de ${player} à la ${minute}e minute, laissant ${team} en infériorité et conditionnant totalement la fin de rencontre.`, forfeit: ({ team }) => `Avec quatre expulsés, ${team} n’avait plus assez de joueurs et l’arbitre a déclaré le match perdu.`,
  ...
  pt: {
    ...
    result: { tier: { goleada: 'GOLEADA!', amplia: 'Vitória ampla', ajustada: 'Vitória apertada', empate: 'Empate', derrota: 'Derrota' }, lostStep: 'Degrau perdido', towerFall: 'Queda da torre', retry: 'Tentar o degrau de novo', nextLevel: 'Próximo nível', reward: 'Recompensa', lossCopy: ({ lives }) => `Você perdeu este degrau. Restam ${lives} vida${lives === 1 ? '' : 's'}.`, rewardCopy: ({ players, items }) => `Recompensa pronta: pacote de ${players} jogadores e ${items} objetos para escolher.`, scorers: 'Artilheiros', reds: 'Expulsos', saves: 'Defesas', lastMatch: 'Última partida', lastTactic: 'Sua tática', gameOver: 'Fim da run', floorsReached: 'andares alcançados', newRecord: '★ Novo recorde', best: ({ best }) => `Melhor marca: ${best}`, winsRoster: ({ wins, count }) => `${wins} vitória${wins === 1 ? '' : 's'} · elenco de ${count} jogadores`, route: 'Percurso', finalSquad: 'Elenco final', playAgain: 'Jogar de novo', pathLevel: ({ level }) => `Nv ${level}` },
    ...
    press: {
      ...
      body: {
        ...
        red: ({ player, team, minute }) => `A partida se complicou com a expulsão de ${player} aos ${minute} minutos, que deixou ${team} em inferioridade e condicionou por completo a reta final.`, forfeit: ({ team }) => `Com quatro expulsos, ${team} ficou sem equipe em campo e o árbitro deu a partida como perdida.`,
  ...
  it: {
    ...
    press: {
      ...
      body: {
        ...
        red: ({ player, team, minute }) => `La partita si è complicata con l’espulsione di ${player} al minuto ${minute}, che ha lasciato ${team} in inferiorità condizionando del tutto il finale.`, forfeit: ({ team }) => `Con quattro espulsi, ${team} è rimasta senza giocatori in campo e l’arbitro ha dato la partita per persa.`,
