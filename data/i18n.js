...
const DICTIONARIES = {
  es: {
    ...
    press: {
      ...
      body: {
        ...
        red: ({ player, team, minute }) => `El partido se complicó con la expulsión de ${player} a los ${minute} minutos, que dejó a ${team} en inferioridad y condicionó por completo el tramo final.`,
  ...
  en: {
    ...
    press: {
      ...
      body: {
        ...
        red: ({ player, team, minute }) => `The match took a turn with ${player}'s sending-off in minute ${minute}, leaving ${team} a man down and completely conditioning the final stretch.`,
  ...
  fr: {
    ...
    result: { tier: { goleada: 'ROUSTE !', amplia: 'Large victoire', ajustada: 'Victoire serrée', empate: 'Match nul', derrota: 'Défaite' }, lostStep: 'Échelon perdu', towerFall: 'Chute de la tour', retry: 'Retenter l’échelon', nextLevel: 'Niveau suivant', reward: 'Récompense', lossCopy: ({ lives }) => `Vous avez perdu cet échelon. Il vous reste ${lives} vie${lives === 1 ? '' : 's'}.`, rewardCopy: ({ players, items }) => `Récompense prête : pack de ${players} joueurs et ${items} objets à choisir.`, scorers: 'Buteurs', saves: 'Arrêts', lastMatch: 'Dernier match', gameOver: 'Fin de run', floorsReached: 'étages atteints', newRecord: '★ Nouveau record', best: ({ best }) => `Meilleure marque : ${best}`, winsRoster: ({ wins, count }) => `${wins} victoire${wins === 1 ? '' : 's'} · effectif de ${count} joueurs`, route: 'Parcours', finalSquad: 'Effectif final', playAgain: 'Rejouer', pathLevel: ({ level }) => `Nv ${level}` },
    ...
    press: {
      ...
      body: {
        ...
        red: ({ player, team, minute }) => `Le match s’est compliqué avec l’expulsion de ${player} à la ${minute}e minute, laissant ${team} en infériorité et conditionnant totalement la fin de rencontre.`,
  ...
  pt: {
    ...
    press: {
      ...
      body: {
        ...
        red: ({ player, team, minute }) => `A partida se complicou com a expulsão de ${player} aos ${minute} minutos, que deixou ${team} em inferioridade e condicionou por completo a reta final.`,
  ...
  it: {
    ...
    press: {
      ...
      body: {
        ...
        red: ({ player, team, minute }) => `La partita si è complicata con l’espulsione di ${player} al minuto ${minute}, che ha lasciato ${team} in inferiorità condizionando del tutto il finale.`,
