    ...
    sections: [
      ...
      { id: 'quimica', nav: 'Química', title: 'Química', blocks: [
        ...
        { ul: [
          ...
          'Cohesión táctica: si la mayoría de tus jugadores encaja con el estilo del equipo (el que marca tu DT).',
          'Capitán: +1 a su línea. Cada jugador del país del DT: +1 a su línea.',
        ] },      ] },
      { id: 'sinergia', nav: 'Sinergia', title: 'Sinergia', blocks: [
        { p: 'La sinergia mide el encaje entre tus objetos y el estilo del equipo, que lo dicta tu director técnico. No la confundas con la química, que es entre jugadores.' },
        { p: 'Si el estilo de un objeto táctico (posesión, presión o contraataque) coincide con el estilo de tu equipo, sus efectos positivos se amplifican (×1,5) y se anulan sus penalizaciones. Los modificadores del DT siempre están en sinergia: el estilo del equipo es el suyo.' },
      ...
      { id: 'objetos', nav: 'Objetos y sobres', title: 'Objetos y sobres', blocks: [
        ...
        { ul: [
          ...
          'Táctica: efectos de estilo de juego, con sinergia según el estilo del equipo.',
          'Reliquia: efectos potentes y singulares.',
        ] },
        { p: 'Los objetos tácticos llevan un estilo (posesión, presión o contraataque). Si coincide con el estilo de tu equipo —el que marca tu DT—, se activa la sinergia: sus efectos se amplifican (×1,5) y desaparecen sus penalizaciones.' },
        { p: 'Repetir un mismo objeto acumula con rendimiento decreciente: cada copia extra rinde un 20% menos que la anterior (2% → 1,6% → 1,28%…). Los objetos distintos siempre suman su efecto completo, y las reliquias que dan cartas extra en los sobres apilan enteras, sin decaimiento.' },
        { p: 'El sobre de objetos ofrece 3 a elegir (4 si ganas por goleada).' },
      ] },
      { id: 'dt', nav: 'Director técnico', title: 'Director técnico (DT)', blocks: [
        ...
        { ul: [
          'Estilo: al elegir un DT, tu equipo adopta su estilo de juego; con esa sinergia sus modificadores positivos se amplifican (×1,5) y se anulan los negativos.',
    ...
    sections: [
      ...
      { id: 'quimica', nav: 'Chemistry', title: 'Chemistry', blocks: [
        ...
        { ul: [
          ...
          'Tactical cohesion: if most of your players match the team style (the one your manager sets).',
          'Captain: +1 to its line. Each player from the manager\'s country: +1 to its line.',
        ] },      ] },
      { id: 'sinergia', nav: 'Synergy', title: 'Synergy', blocks: [
        { p: 'Synergy measures the fit between your items and the team style, which your manager dictates. Don\'t confuse it with chemistry, which is between players.' },
        { p: 'If the style of a tactical item (possession, pressing or counter-attack) matches your team style, its positive effects are amplified (×1.5) and its penalties are cancelled. The manager\'s modifiers are always in synergy: the team style is their own.' },
      ...
      { id: 'objetos', nav: 'Items and packs', title: 'Items and packs', blocks: [
        ...
        { ul: [
          ...
          'Tactic: playing-style effects, with synergy depending on the team style.',
          'Relic: powerful, one-off effects.',
        ] },
        { p: 'Tactical items carry a style (possession, pressing or counter-attack). If it matches your team style — the one your manager sets — synergy triggers: their effects are amplified (×1.5) and their penalties disappear.' },
        { p: 'Stacking the same item has diminishing returns: each extra copy is worth 20% less than the previous one (2% → 1.6% → 1.28%…). Different items always add their full effect, and the relics that grant extra cards in packs stack whole, with no decay.' },
        { p: 'The item pack offers 3 to choose from (4 if you win by a thrashing).' },
      ] },
      { id: 'dt', nav: 'Manager', title: 'Manager', blocks: [
        ...
        { ul: [
          'Style: when you pick a manager, your team adopts their playing style; with that synergy their positive modifiers are amplified (×1.5) and the negative ones are cancelled.',
    ...
    sections: [
      ...
      { id: 'quimica', nav: 'Alchimie', title: 'Alchimie', blocks: [
        ...
        { ul: [
          ...
          'Cohésion tactique : si la majorité de tes joueurs colle au style de l\'équipe (celui fixé par ton entraîneur).',
          'Capitaine : +1 à sa ligne. Chaque joueur du pays de l\'entraîneur : +1 à sa ligne.',
        ] },      ] },
      { id: 'sinergia', nav: 'Synergie', title: 'Synergie', blocks: [
        { p: 'La synergie mesure l\'accord entre tes objets et le style de l\'équipe, dicté par ton entraîneur. À ne pas confondre avec l\'alchimie, qui est entre joueurs.' },
        { p: 'Si le style d\'un objet tactique (possession, pressing ou contre-attaque) correspond au style de ton équipe, ses effets positifs sont amplifiés (×1,5) et ses pénalités annulées. Les modificateurs de l\'entraîneur sont toujours en synergie : le style de l\'équipe est le sien.' },
      ...
      { id: 'objetos', nav: 'Objets et paquets', title: 'Objets et paquets', blocks: [
        ...
        { ul: [
          ...
          'Tactique : effets de style de jeu, avec synergie selon le style de l\'équipe.',
          'Relique : effets puissants et singuliers.',
        ] },
        { p: 'Les objets tactiques portent un style (possession, pressing ou contre-attaque). S\'il correspond au style de ton équipe — celui fixé par ton entraîneur —, la synergie se déclenche : leurs effets sont amplifiés (×1,5) et leurs pénalités disparaissent.' },
        { p: 'Cumuler un même objet a un rendement décroissant : chaque copie supplémentaire rapporte 20 % de moins que la précédente (2 % → 1,6 % → 1,28 %…). Les objets différents s\'additionnent toujours en entier, et les reliques qui donnent des cartes en plus dans les paquets s\'empilent entières, sans décroissance.' },
        { p: 'Le paquet d\'objets en propose 3 au choix (4 en cas de raclée).' },
      ] },
      { id: 'dt', nav: 'Entraîneur', title: 'Entraîneur', blocks: [
        ...
        { ul: [
          'Style : en choisissant un entraîneur, ton équipe adopte son style de jeu ; avec cette synergie, ses modificateurs positifs sont amplifiés (×1,5) et les négatifs annulés.',
    ...
    sections: [
      ...
      { id: 'quimica', nav: 'Química', title: 'Química', blocks: [
        ...
        { ul: [
          ...
          'Coesão tática: se a maioria dos seus jogadores combina com o estilo do time (o que o seu treinador define).',
          'Capitão: +1 à sua linha. Cada jogador do país do treinador: +1 à sua linha.',
        ] },      ] },
      { id: 'sinergia', nav: 'Sinergia', title: 'Sinergia', blocks: [
        { p: 'A sinergia mede o encaixe entre os seus objetos e o estilo do time, ditado pelo seu treinador. Não confunda com a química, que é entre jogadores.' },
        { p: 'Se o estilo de um objeto tático (posse, pressão ou contra-ataque) coincide com o estilo do seu time, os efeitos positivos são amplificados (×1,5) e as penalidades anuladas. Os modificadores do treinador estão sempre em sinergia: o estilo do time é o dele.' },
      ...
      { id: 'objetos', nav: 'Objetos e pacotes', title: 'Objetos e pacotes', blocks: [
        ...
        { ul: [
          ...
          'Tática: efeitos de estilo de jogo, com sinergia conforme o estilo do time.',
          'Relíquia: efeitos potentes e singulares.',
        ] },
        { p: 'Os objetos táticos têm um estilo (posse, pressão ou contra-ataque). Se coincide com o estilo do seu time — o que o seu treinador define —, a sinergia é ativada: os efeitos são amplificados (×1,5) e as penalidades desaparecem.' },
        { p: 'Repetir o mesmo objeto acumula com rendimento decrescente: cada cópia extra rende 20% menos que a anterior (2% → 1,6% → 1,28%…). Objetos diferentes sempre somam o efeito completo, e as relíquias que dão cartas extras nos pacotes acumulam inteiras, sem decaimento.' },
        { p: 'O pacote de objetos oferece 3 à escolha (4 em caso de goleada).' },
      ] },
      { id: 'dt', nav: 'Treinador', title: 'Treinador', blocks: [
        ...
        { ul: [
          'Estilo: ao escolher um treinador, o seu time adota o estilo de jogo dele; com essa sinergia, os modificadores positivos são amplificados (×1,5) e os negativos anulados.',
    ...
    sections: [
      ...
      { id: 'quimica', nav: 'Intesa', title: 'Intesa', blocks: [
        ...
        { ul: [
          ...
          'Coesione tattica: se la maggioranza dei tuoi giocatori si adatta allo stile della squadra (quello fissato dal tuo allenatore).',
          'Capitano: +1 alla sua linea. Ogni giocatore del paese dell\'allenatore: +1 alla sua linea.',
        ] },      ] },
      { id: 'sinergia', nav: 'Sinergia', title: 'Sinergia', blocks: [
        { p: 'La sinergia misura l\'incastro tra i tuoi oggetti e lo stile della squadra, dettato dal tuo allenatore. Da non confondere con l\'intesa, che è tra giocatori.' },
        { p: 'Se lo stile di un oggetto tattico (possesso, pressing o contropiede) coincide con lo stile della tua squadra, gli effetti positivi vengono amplificati (×1,5) e le penalità annullate. I modificatori dell\'allenatore sono sempre in sinergia: lo stile della squadra è il suo.' },
      ...
      { id: 'objetos', nav: 'Oggetti e pacchetti', title: 'Oggetti e pacchetti', blocks: [
        ...
        { ul: [
          ...
          'Tattica: effetti di stile di gioco, con sinergia in base allo stile della squadra.',
          'Reliquia: effetti potenti e unici.',
        ] },
        { p: 'Gli oggetti tattici hanno uno stile (possesso, pressing o contropiede). Se coincide con lo stile della tua squadra — quello fissato dal tuo allenatore —, la sinergia si attiva: gli effetti vengono amplificati (×1,5) e le penalità spariscono.' },
        { p: 'Accumulare lo stesso oggetto ha rendimenti decrescenti: ogni copia extra rende il 20% in meno della precedente (2% → 1,6% → 1,28%…). Oggetti diversi sommano sempre l\'effetto completo, e le reliquie che danno carte extra nei pacchetti si accumulano intere, senza decadimento.' },
        { p: 'Il pacchetto di oggetti ne propone 3 a scelta (4 in caso di goleada).' },
      ] },
      { id: 'dt', nav: 'Allenatore', title: 'Allenatore', blocks: [
        ...
        { ul: [
          'Stile: scegliendo un allenatore, la tua squadra adotta il suo stile di gioco; con questa sinergia i modificatori positivi vengono amplificati (×1,5) e quelli negativi annullati.',
